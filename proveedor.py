...
async def buscar_por_rfc(
    ...
    return {"success": True, "data": ProveedorRead.model_validate(proveedor)}, description="Código postal de 5 dígitos")
    pais: Optional[str] = Field("México", max_length=50)
    observaciones: Optional[str] = None
...
class ProveedorUpdate(BaseModel):
    ...
    ciudad: Optional[str] = Field(None, max_length=100)
    estado: Optional[str] = Field(None, max_length=100)
    codigo_postal: Optional[str] = Field(None, max_length=10, regex=r'^\d{5}$')
    pais: Optional[str] = Field(None, max_length=50)
    observaciones: Optional[str] = None
